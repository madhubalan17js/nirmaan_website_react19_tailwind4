        ...
        <div className="relative mx-auto max-w-[1280px] px-6 pt-0 pb-0 lg:pt-14 lg:pb-0">
          ...
          <div className="relative z-10 flex flex-col gap-8 lg:flex-row">
            ...
            <div className="w-full text-left">
              <p className="text-3xl font-light leading-tight text-gray-800 lg:text-5xl">
                Empowering <span className="font-bold">India</span> with <span className="font-bold">Innovative</span>
                ...
                <span className="font-bold ml-1">MEP</span> Solutions.
              </p>
      ...
      <div className="w-full pt-10 pb-12 lg:pt-4" style={{ backgroundColor: LIGHT_BG }}>
        <div className="mx-auto max-w-[1280px] px-6">
          ...
          <div className=" flex flex-row justify-between lg:text-left mb-10">
            <p className="text-3xl lg:text-4xl font-light text-gray-800">
